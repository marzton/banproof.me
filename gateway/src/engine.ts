...
// BanproofEngine — Cloudflare Workflow (Hybrid Mock/RealRun wrangler d1 create gs-platform-prod and wrangler kv:namespace create INFRA_SECRETS, then paste the returned UUIDs into each app's wrangler.toml and infra/bindings.json
// Durable, checkpointed processing for slow external APIs.
